...
if __name__ == "__main__":
    ...
    layout = [
        ...
        [sg.Text('当前工作薄', size=text_size), sg.InputText(key="current_book", readonly=True)],
    ...
    # 创造窗口
    window = sg.Window('Window Title', layout, size=(800, 350))
